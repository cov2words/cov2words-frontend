...
var OriginStampClientJSModule = /** @class */ (function () {
    /**
     * Contains functionality related to user session management.
     */
    function OriginStampClientJSModule() {
    }
    OriginStampClientJSModule = __decorate([
        NgModule({
            imports: [
                CommonModule,
    ...
    return OriginStampClientJSModule;
}());
export { OriginStampClientJSModule };
//# sourceMappingURL=originstamp_client_js.module.js.map